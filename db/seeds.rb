...
LikedTweet.new(user: tom, tweet: Tweet.find(11)).save
LikedTweet.new(user: tom, tweet: Tweet.find(12)).save
LikedTweet.new(user: tom, tweet: Tweet.find(13)).save
LikedTweet.new(user: tom, tweet: Tweet.find(14)).save
LikedTweet.new(user: tom, tweet: Tweet.find(15)).save
LikedTweet.new(user: tom, tweet: Tweet.find(16)).save
...
RepliedTweet.new(user: tom, tweet: Tweet.create(tweet: Faker::Hacker.say_something_smart, user: tom), replied_to_tweet_id: 12).save
RepliedTweet.new(user: tom, tweet: Tweet.create(tweet: Faker::Hacker.say_something_smart, user: tom), replied_to_tweet_id: 13).save
